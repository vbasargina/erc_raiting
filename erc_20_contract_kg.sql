...
Select 
	...
	Case 
		When c.contractrejectdate::date>to_date('${date}','YYYY-MM-DD') Then Null 
...
Inner Join nrpz.erc_dwh_proced_detail_kg_${srez_number} d On d.lotuuid::int4=c.lotid And customerid Not In (3039,2913,31344,2998,3020,2901,3024,2994,7817,3774,29714,3127,3128,3132,3133,2147,3011,1556,2983)
...
Select 
		...
		End stage,
		c.contractactualexecdate executions_date,
		Case When c.contractrejectdate::date>to_date('${start_date}','yyyy-mm-dd') Then Null Else c.contractrejectdate End rejected_date, 
		...
		c.is_concluded_in_e_shop,
		c.lotid,
		d.requestid, Case When length(c.contractrnk)>13 then 1 Else 0 End flag_16,
		c.firstnoticedate firstnoticesuccesdate,
	    CASE
		 WHEN c.is_structured_form='f' THEN 'Нет'
		 WHEN c.is_structured_form='t' THEN 'Да'
...
Join sppr.dwh_procedures_detailed_kgntv d On d.lotuuid=c.lotid And customerid  not In (3039,2913,31344,2998,3020,2901,3024,2994,7817,3774,29714,3127,3128,3132,3133,2147,3011,1556,2983 )
Left Join nrpz.erc_${year}_schedule_pos sch On sch.ikz = d.pg_ikz AND sch.plannumber=d.pg_rn --  от 27.01.2025  добавлено условие sch.plannumber=d.pg_rn, т.к. есть разные ППГ, но один ИКЗ ikz = '242780702876978070100100010000000244'
Left Join (Select distinct id From sppr.dwh_contract_penalty_kgntv Where reason_id In (1,3)) pen On pen.id = c.contractid
Left Join nrpz.erc_${year}_contract cc On cc.rnk = c.contractrnk
/*Left Join
...
Where 
grbsid = 1894 
or org_inn In ('7822002853', '7806143720', '7806143737', '7802215268', '7802215250', '7817044400', '7819029196', '7805283280', '7807053821', '7807053839', '7805283273', '7810293894', 
'7810293904', '7804169401', '7804169391', '7820038893', '7843000046', '7816226502', '7816226189', '7814143064', '7813188464', '7820038903', '7814143057', '7843000039', '7842000050', 
'7839000318', '7842000068', '7811139119', '7801238167', '7811139084', '7820073802', '7801682580', '7817106590', '7842181030', '7819042648', '7813644519', '7839127850', '7805765622', 
'7805765615', '7807241381', '7807241374', '7810795943', '7811747981', '7806573056', '7804670495', '7802708190', '7802708182', '7802708150', '7811747935', '7806573031', '7804670382', 
'7804670431', '7804670375', '7811747999', '7816706900', '7816706971', '7814776557', '7811747974', '7816706989', '7814776500', '7811747928', '7814776564', '7816706925', '7801682598', 
'7807022277', '7812031703', '7813585510', '7819029206', '7825439419', '7838389412', '7838468985', '7840425330' )
;
...
Where sop_name_reqnum in ('Закупка товара у единственного поставщика на сумму, предусмотренную частью 12 статьи 93 Закона № 44-ФЗ',
						  ...
						  'Закупка товара у единственного поставщика (ч.12 ст.93)') 
And rnk is not null;
